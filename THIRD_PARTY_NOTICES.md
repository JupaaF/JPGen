...
JPGen wheels include a modified Kratos Multi-Physics Core and DEM Application.
The source revision is recorded in `jpgen/_kratos_runtime/KRATOS-REVISION`.
Their license texts are distributed in the same directory as
`KRATOS-CORE-LICENSE.txt` and `KRATOS-DEM-LICENSE.txt`.
